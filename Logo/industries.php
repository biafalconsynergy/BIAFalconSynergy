...
<head>
    <title>Industries | KONNEXIO</title>
    <meta charset="utf-8">
        ...
        <div class="row no-gutters" id="industrial">
            ...
            <div class="col-sm-6">
                <div class="sec3b bg-light">
                    ...
                    <button class="btn btn-danger btn-lg" onclick="location.href='/BIAFalconSynergy/contact.php';">Request a Consultation</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row no-gutters" id="agriculture">
            <div class="col-sm-6">
                <div class="sec3b bg-light">
                    ...
                    <button class="btn btn-danger btn-lg" onclick="location.href='/BIAFalconSynergy/contact.php';">Schedule a Demo</button>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="sec3b bg-light">
        ...
        <div class="row no-gutters" id="hydrogen_fuel_cells">
            ...
            <div class="col-sm-6">
                <div class="sec3b bg-light">
                    ...
                    <button class="btn btn-danger btn-lg" onclick="location.href='/BIAFalconSynergy/contact.php';">Contact Us for a Free Assessment</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row no-gutters" id="other_industries">
            <div class="col-sm-6">
                <div class="sec3b bg-light">
                    ...
                    <button class="btn btn-danger btn-lg" onclick="location.href='/BIAFalconSynergy/contact.php';">Customize Your Solution</button>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="sec3b bg-light">
