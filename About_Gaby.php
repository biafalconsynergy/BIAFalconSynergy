        ...
        <!-- Careers Section -->
            <section id="careers" class="container-fluid p-3 bg-light text-dark custom margin">
                <div class="text-center mb-4">
					...
					<p class="section-subtitle">We would love to hear from you and keep your profile in our records.</p>
					<p class="section-subtitle">Please submit your resume for future consideration to <a href="mailto:careers@konnexio.ca">careers@konnexio.ca</a></p>
                </div>
