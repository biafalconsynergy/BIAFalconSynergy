        ...
        <div class="row no-gutters" id="industrial">
            ...
            <div class="col-sm-6">
                <div class="sec3b bg-light">
                    ...
                    <button class="btn btn-danger btn-lg" onclick="location.href='contact.php';">Request a Consultation</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row no-gutters" id="hydrogen_fuel_cells">
            ...
            <div class="col-sm-6">
                <div class="sec3b bg-light">
                    ...
                    <button class="btn btn-danger btn-lg" onclick="location.href='contact.php';">Contact Us for an Assessment</button>
                </div>
            </div>
        </div>
    </section>
