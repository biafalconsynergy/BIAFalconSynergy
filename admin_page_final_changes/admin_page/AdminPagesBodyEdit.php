                        ...
                        <div class="table-responsive">
                            ...
                            <?php
								...
								<form method="post" enctype="multipart/form-data">
										...
										for ($i = 0; $i < count($tableColumnNames); $i++) {
											...
											if (in_array($columnName, $disabletableColumnNames)) {
												...
												echo '<div class="mb-3">
													...
													<input type="text" class="form-control" id="formGroupExampleInput'.$i.'" name="'.$columnName.'" value="'.$row[$columnName].'" readonly>
												</div>';
									...
									<a class="btn btn-secondary" href="CaseStudy.php">Cancel</a>
								</form>
