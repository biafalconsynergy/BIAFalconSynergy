    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-4 footer-section">
                <h5 class="footer-heading"><a href="about.php">About</a></h5>
                <ul class="list-unstyled">
                    <li><a href="about.php#company_story">Company Story</a></li>
            ...
            <div class="col-lg-2 col-md-4 footer-section">
                ...
                <ul class="list-unstyled">
                    <li><a href="adapto.php">adapto™</a></li>
                    <li><a href="custom_machines.php">Custom Machines</a></li>
                    <li><a href="case_studies.php">Case Studies</a></li>
                </ul>
            </div>
            <div class="col-lg-2 col-md-4 footer-section">
                <h5 class="footer-heading"><a href="services.php">Services</a></h5>
                <ul class="list-unstyled">
                    <li><a href="services.php#design">Design</a></li>
                    <li><a href="services.php#build">Build</a></li>
                    <li><a href="services.php#support">Support</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-4 footer-section">
