...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2024 at 03:04 AM
...
-- --------------------------------------------------------
-- Create the database
CREATE DATABASE konnexio;

-- Create the user
CREATE USER 'konnexio'@'localhost' IDENTIFIED BY 'Kon@BIA098';

-- Grant global data-related privileges
GRANT 
    SELECT, INSERT, UPDATE, DELETE, FILE        -- Data privileges
ON *.* TO 'konnexio'@'localhost';

-- Grant global structure-related privileges
GRANT 
    CREATE, ALTER, CREATE VIEW                  -- Structure privileges
ON *.* TO 'konnexio'@'localhost';

-- Grant global administration privileges
GRANT 
    GRANT OPTION, CREATE USER                   -- Administration privileges
ON *.* TO 'konnexio'@'localhost';
...
(1, 1, 'Automotive Hinge Assembly', 'Explore KONNEXIO\'s custom automation solutions for assembling automotive hinges, where tailored machine designs and seamless integration bring your project vision to life, ensuring optimal production efficiency.', CURRENT_TIMESTAMP(), 'cs_Image1.jpg', 1, CURRENT_TIMESTAMP(), '<script charset=\"utf-8\" type=\"text/javascript\" src=\"//js.hsforms.net/forms/embed/v2.js\"></script>\r\n<script>\r\n  hbspt.forms.create({\r\n    region: \"na1\",\r\n    portalId: \"46894280\",\r\n    formId: \"a1580df7-b785-454f-9de7-02aba0300988\"\r\n  });\r\n</script>'),
(2, 1, 'Automotive Door Checker Assembly', 'Experience KONNEXIO\'s expertise in custom automation, crafting and integrating tailored solutions for automotive door checker assembly to ensure precise and efficient operation.', CURRENT_TIMESTAMP(), 'cs_Image2.jpg', 1, CURRENT_TIMESTAMP(), '<script charset=\"utf-8\" type=\"text/javascript\" src=\"//js.hsforms.net/forms/embed/v2.js\"></cript>\r\n<script>\r\n  hbspt.forms.create({\r\n    region: \"na1\",\r\n    portalId: \"46894280\",\r\n    formId: \"a1580df7-b785-454f-9de7-02aba0300988\"\r\n  });\r\n</script>\r\n'),
(3, 1, 'Automotive Fuel Line Assembly & Testing', 'Trust KONNEXIO to deliver custom automation for automotive fuel line assembly and testing, combining expert machine design with efficient project management for superior quality and safety.', CURRENT_TIMESTAMP(), 'cs_Image3.jpg', 1, CURRENT_TIMESTAMP(), '<script charset=\"utf-8\" type=\"text/javascript\" src=\"//js.hsforms.net/forms/embed/v2.js\"></cript>\r\n<script>\r\n  hbspt.forms.create({\r\n    region: \"na1\",\r\n    portalId: \"46894280\",\r\n    formId: \"a1580df7-b785-454f-9de7-02aba0300988\"\r\n  });\r\n</script>\r\n'),
(4, 1, 'Automotive Plug Seal Assembly & Testing', 'KONNEXIO offers custom automation solutions for plug seal assembly and testing, transforming your vision into reality with seamless integration and optimized production.', CURRENT_TIMESTAMP(), 'cs_Image4.jpg', 1, CURRENT_TIMESTAMP(), '<script charset=\"utf-8\" type=\"text/javascript\" src=\"//js.hsforms.net/forms/embed/v2.js\"></cript>\r\n<script>\r\n  hbspt.forms.create({\r\n    region: \"na1\",\r\n    portalId: \"46894280\",\r\n    formId: \"a1580df7-b785-454f-9de7-02aba0300988\"\r\n  });\r\n</script>\r\n'),
(5, 1, 'Automotive Fuel Line Assembly', 'Leverage KONNEXIO\'s custom automation to enhance your automotive fuel line assembly process, ensuring top-tier efficiency and quality through tailored machine designs.', CURRENT_TIMESTAMP(), 'cs_Image5.jpg', 1, CURRENT_TIMESTAMP(), '<script charset=\"utf-8\" type=\"text/javascript\" src=\"//js.hsforms.net/forms/embed/v2.js\"></cript>\r\n<script>\r\n  hbspt.forms.create({\r\n    region: \"na1\",\r\n    portalId: \"46894280\",\r\n    formId: \"a1580df7-b785-454f-9de7-02aba0300988\"\r\n  });\r\n</script>\r\n'),
(6, 1, 'Automotive Transmission Line Assembly', 'KONNEXIO provides bespoke automation solutions for transmission line assembly, ensuring seamless integration and maximum efficiency in your automotive production line.', CURRENT_TIMESTAMP(), 'cs_Image6.jpg', 0, CURRENT_TIMESTAMP(), '<script charset=\"utf-8\" type=\"text/javascript\" src=\"//js.hsforms.net/forms/embed/v2.js\"></cript>\r\n<script>\r\n  hbspt.forms.create({\r\n    region: \"na1\",\r\n    portalId: \"46894280\",\r\n    formId: \"a1580df7-b785-454f-9de7-02aba0300988\"\r\n  });\r\n</script>\r\n'),
(7, 1, 'Locomotive Brake Handle Tester', 'Rely on KONNEXIO\'s custom automation expertise for testing locomotive brake handles, with machine designs tailored to your specifications and integrated for peak performance.', CURRENT_TIMESTAMP(), 'cs_Image7.jpg', 1, CURRENT_TIMESTAMP(), '<script charset=\"utf-8\" type=\"text/javascript\" src=\"//js.hsforms.net/forms/embed/v2.js\"></cript>\r\n<script>\r\n  hbspt.forms.create({\r\n    region: \"na1\",\r\n    portalId: \"46894280\",\r\n    formId: \"a1580df7-b785-454f-9de7-02aba0300988\"\r\n  });\r\n</script>\r\n'),
(8, 1, 'Hybrid Automotive Sensor Tester', 'KONNEXIO transforms your vision with custom automation for hybrid automotive sensor testing, ensuring precise, efficient operation with seamless integration.', CURRENT_TIMESTAMP(), 'cs_Image8.jpg', 1, CURRENT_TIMESTAMP(), '<script charset=\"utf-8\" type=\"text/javascript\" src=\"//js.hsforms.net/forms/embed/v2.js\"></cript>\r\n<script>\r\n  hbspt.forms.create({\r\n    region: \"na1\",\r\n    portalId: \"46894280\",\r\n    formId: \"a1580df7-b785-454f-9de7-02aba0300988\"\r\n  });\r\n</script>\r\n');
